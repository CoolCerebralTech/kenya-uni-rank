    ...
    <footer className="mt-16 border-t border-border-light dark:border-border bg-background-light dark:bg-background py-8">
      <div className="mx-auto max-w-7xl px-4">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          {/* Disclaimer */}
          <div className="max-w-md text-xs bg-brand-blue/5 dark:bg-background-subtle rounded-lg p-4 border border-brand-blue/20 shadow-card">
            <strong className="text-brand-blue dark:text-gray-300">Disclaimer:</strong>{" "}
